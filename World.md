...
```
    ...
    ## Summary of sample sizes: 4721, 4719, 4720, 4720, 4720 
    ## Resampling results:
    ## 
    ##   RMSE      Rsquared    MAE    
    ##   4743.003  0.01895642  1797.42
    ## 
...
```
    ...
    ## Pre-processing: centered (7), scaled (7) 
    ## Resampling: Cross-Validated (5 fold) 
    ## Summary of sample sizes: 4721, 4721, 4719, 4720, 4719 
    ## Resampling results:
    ## 
    ##   RMSE     Rsquared    MAE     
    ##   4828.69  0.01430924  1798.767
    ## 
    ## Tuning parameter 'intercept' was held constant at a value of TRUE
...
```
    ...
    ##   1     4728.993  0.01807379  1811.369
    ##   2     4789.984  0.01703603  1881.803
    ##   3     4839.986  0.01524004  1913.342
    ##   4     4882.296  0.01409636  1945.573
    ##   5     4914.180  0.01338715  1961.608
    ## 
...
```
    ...
    ## Pre-processing: centered (7), scaled (7) 
    ## Resampling: Cross-Validated (5 fold) 
    ## Summary of sample sizes: 4720, 4720, 4720, 4719, 4721 
    ## Resampling results across tuning parameters:
    ## 
    ##   interaction.depth  n.trees  RMSE      Rsquared     MAE     
    ##   1                   50      4843.412  0.015929733  1797.296
    ##   1                  100      4844.923  0.016361739  1795.006
    ##   1                  150      4845.582  0.017135626  1807.775
    ##   1                  200      4847.263  0.017772918  1819.266
    ##   2                   50      4892.695  0.009821931  1810.477
    ##   2                  100      4902.245  0.012405855  1815.969
    ##   2                  150      4928.105  0.012287492  1836.326
    ##   2                  200      4961.985  0.009813742  1856.192
    ##   3                   50      4917.451  0.009395070  1820.114
    ##   3                  100      4962.886  0.008229658  1843.558
    ##   3                  150      4985.690  0.008324961  1861.151
    ##   3                  200      5020.363  0.008648288  1898.940
    ##   4                   50      4936.563  0.009351351  1836.307
    ##   4                  100      4990.944  0.008147860  1875.007
    ##   4                  150      5023.123  0.006523430  1908.126
    ##   4                  200      5043.409  0.007895191  1925.907
    ## 
...
```
    ...
    ## [1] "The model with the lowest RMSE value is the Boosted Tree model"
